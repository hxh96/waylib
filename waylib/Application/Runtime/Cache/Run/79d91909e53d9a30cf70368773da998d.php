	...
	<body style="background: #f0f0f0;">
		<div class="changepsw">
			<div class="change_head">
				...
				<img src="/Public/Run/img/czmm.png" />
			</div>
			</div>
			...
			<div class="change_main">
				<div class="changge_center">
					<div class="change_form">
						...
						<button class="sure" id="sureBtn">确&nbsp;&nbsp;认</button>
					</div>
				</div>
			</div>
		</div>
						...
						$.ajax({
							...
							success:function(data){
								...
								if(data.code == 100){
									...
									$.ajax({
										type:'post',
										url:"<?php echo U('Login/forgetPwd');?>",
										data:'u_pwd='+password+'&phone='+phone,
										dataType:'json',
										success:function(data){
											if(data.code == 1) {
